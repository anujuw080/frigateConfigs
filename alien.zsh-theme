...
# JUNKFOOD_TIME_="%{$fg_bold[white]%}[ %{$fg_bold[limegreen]%}%t %{$fg_bold[lime]%}]  %{$reset_color%}"
...
# # Put it all together!
# PROMPT="$JUNKFOOD_TIME_$JUNKFOOD_LOCA_
#    "
...
PROMPT="%{$fg_bold[lime]%}[%{$fg_bold[lime]%}%t%{$fg_bold[lime]%}][%{$fg[lime]%}%~]$(git_prompt_info)᚛ "